...
import type { AppStep } from './step-indicator.js';
...
import { SaveCompositionModal } from './save-composition-modal.js';
import { MyCompositions } from './my-compositions.js';
import { MyAssets } from './my-assets.js';
import { ImageUpload } from './image-upload.js';
import { MediaBrowserDialog } from './media-browser-dialog.js';
import { CompositionMenu } from './composition-menu.js';
import { DiscardConfirmationDialog } from './discard-confirmation-dialog.js';
...
export const TabContent = forwardRef<TabContentHandle, TabContentProps>(function TabContent({ tabId, isActive }, ref) {
  ...
  // Read URL params on mount — reproduce pattern from URL (only for active tab)
  useEffect(() => {
    if (!isActive) return;
  ...
  }, [isActive, slug, patternType, colorSchemeIndex, zoom, txVal, tyVal, userOverrides, useTranslate, rotate, skewX, skewY]);
  ...
  }, [isActive, restoreColorAdjusted, applyContrastBrightnessAndCache, applyHslAndCache, generateAndCache, imageLayers]);
