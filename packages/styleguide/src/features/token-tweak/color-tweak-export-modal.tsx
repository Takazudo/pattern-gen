...
export default function ColorTweakExportModal({ onClose, colorState }: ColorTweakExportModalProps) {
  ...
  return (
    ...
    >
      <h2 className="mb-vsp-sm text-subheading font-bold text-fg">Export Color Scheme</h2>
