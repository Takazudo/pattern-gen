/**
 * Frame system type definitions.
 * Frames are decorative borders drawn on OGP images.
 */
 ...
 */
export type FrameParamDef = SliderFrameParam | ColorFrameParam | SelectFrameParam | ToggleFrameParam;
